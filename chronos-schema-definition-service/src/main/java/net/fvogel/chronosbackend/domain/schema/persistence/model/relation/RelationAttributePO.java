...
public class RelationAttributePO {
    ...
    @NotNull(message = I18nConstants.Errors.Relations.Attributes.KEY_NOT_SPECIFIED)
    String key;
    ...
    @NotNull(message = I18nConstants.Errors.Relations.Attributes.LABEL_NOT_SPECIFIED)
    String label;
    ...
    @NotNull(message = I18nConstants.Errors.Relations.Attributes.TYPE_NOT_SPECIFIED)
    AttributeType type;
