package net.fvogel.chronos.data.general.wikipedia.service;
...
import net.fvogel.chronos.data.config.caching.CachingConfig;
import net.fvogel.chronos.data.general.wikipedia.client.WikipediaApiClient;
import net.fvogel.chronos.data.general.wikipedia.dto.WikipediaPageDto;
import net.fvogel.chronos.data.general.wikipedia.dto.WikipediaQueryResultDto;
import net.fvogel.chronos.data.general.wikipedia.dto.getentities.WikipediaEntityDto;
import net.fvogel.chronos.data.general.wikipedia.dto.getentities.WikipediaEntityResultDto;
import net.fvogel.chronos.data.general.wikipedia.dto.getentities.WikipediaSiteLinkDto;
import net.fvogel.chronos.data.general.wikipedia.dto.search.WikipediaSearchResultDto;
import net.fvogel.chronos.data.general.wikipedia.mapper.WikipediaModelMapper;
import net.fvogel.chronos.data.general.wikipedia.model.WikipediaArticleInfo;
