...
import net.fvogel.chronos.data.domain.generic.model.EntityFieldMetadata;
import net.fvogel.chronos.data.domain.generic.model.EntityMetadata;
import net.fvogel.chronos.data.domain.generic.model.RelationMetadata;
...
import static net.fvogel.chronos.data.domain.generic.service.ReflectionUtils.*;
...
public class MetadataService {
    ...
    private static final String packageName = "net.fvogel.chronos.data.domain";
