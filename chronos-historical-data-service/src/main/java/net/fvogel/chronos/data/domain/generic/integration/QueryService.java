...
import net.fvogel.chronos.data.domain.generic.service.MetadataService;
...
import static net.fvogel.chronos.data.domain.generic.service.ReflectionUtils.getFieldStringValue;
